...
public class OAuth implements Authentication {
     ...
     *
     * @param redirectUri Uri the user is redirected to, after successful authorization.
     *                    This must be the same as specified at the Eve Online developer
     *                    page.
     * @param scopes      Scopes of the Eve Online SSO.
     * @param state       This should be some secret to prevent XRSF, please read:
     ...
     *
     * @param code         Code returned by the Eve Online SSO
     * @param state        This should be some secret to prevent XRSF see
     *                     getAuthorizationUri
     * @param codeVerifier The PKCE code verifier used to generate the code challenge
    ...
    private static void update(AccountData accountData, String urlParameters) throws ApiException {
        try {
            ...
            con.setRequestProperty("Host", "login.evepc.163.com");
