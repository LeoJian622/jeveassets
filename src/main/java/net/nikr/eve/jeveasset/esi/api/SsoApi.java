package net.nikr.eve.jeveasset.esi.api;

import net.nikr.eve.jeveasset.esi.*;
import net.nikr.eve.jeveasset.esi.auth.OAuth;
import net.nikr.eve.jeveasset.esi.model.CharacterInfo;
 ...
 */
public class SsoApi {
    private static final String URI_REVOKE = "https://login.evepc.163.com";
    ...
    /**
     * Alias for net.nikr.eve.jeveasset.esiapi.MetaApi.getVerify() Return CharacterInfo
    ...
    private okhttp3.Call postRevokeTokenCall(final String token, final String tokenTypeHint, final ApiCallback _callback)
        ...
        localVarHeaderParams.put("Host", "login.evepc.163.com");
